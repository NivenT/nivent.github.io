...
\frac12\sum_{a=1}^{g-1}\binom{2g}{2a}\sqbracks{\frac{e^3a^a(g-a)^{g-a}}{2g^g}}^m
\end{align}$$
...
$$M_g\le\frac{2(g-1)^{gm-4}}{g^{gm-3}}=2\left.\parens{\frac{g-1}g}^{gm-4}\right/g\longrightarrow0\text{ as }g\to\infty$$
