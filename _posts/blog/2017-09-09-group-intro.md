...
Note that the above group is called the **direct product** of $$G$$ and $$H$$. It is sometimes also denoted $$G\oplus H$$, and called their **direct sum**. These notions are the same here, but differ if you start talking about the direct product/sum of infinite collections of groups; however, we won't get into that here.
